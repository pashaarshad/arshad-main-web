    ...
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Education Card */}
          <div className="about-card bg-card-bg backdrop-blur-md border border-border-secondary hover:border-accent-primary rounded-xl p-6 hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-glow group">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-accent-primary/10 p-3 rounded-lg group-hover:bg-accent-primary/20 transition-colors">
                <svg className="w-6 h-6 text-accent-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-text-primary group-hover:text-accent-primary transition-colors">Education</h3>
            </div>
            <div className="space-y-3">
              <div>
                <p className="font-semibold text-accent-primary">BCA - 9.2 CGPA</p>
                <p className="text-sm text-text-secondary">Seshadripuram Degree College</p>
                <p className="text-xs text-text-tertiary">2023 - 2026</p>
              </div>
              <div>
                <p className="font-semibold text-accent-primary">PU - 81.50%</p>
                <p className="text-sm text-text-secondary">St. Joseph's Composite PU College</p>
                <p className="text-xs text-text-tertiary">2021 - 2023</p>
              </div>
            </div>
          </div>

          {/* Leadership Card */}
          <div className="about-card bg-card-bg backdrop-blur-md border border-border-secondary hover:border-accent-secondary rounded-xl p-6 hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-glow group">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-accent-secondary/10 p-3 rounded-lg group-hover:bg-accent-secondary/20 transition-colors">
              ...
              <h3 className="text-xl font-bold text-text-primary group-hover:text-accent-secondary transition-colors">Leadership</h3>
            </div>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                <span className="text-accent-secondary mt-1">★</span>
                <span className="text-text-secondary">Education Vice-Captain – PU College</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-accent-secondary mt-1">★</span>
                <span className="text-text-secondary">Class Representative – Degree College</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-accent-secondary mt-1">★</span>
                <span className="text-text-secondary">Open-Source Contributor: SSOC</span>
              </li>
            </ul>
          </div>
          ...
          <div className="about-card bg-card-bg backdrop-blur-md border border-border-secondary hover:border-accent-primary rounded-xl p-6 hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-glow group">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-text-primary group-hover:text-accent-primary transition-colors">Awards</h3>
            </div>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                <span className="text-accent-primary mt-1">🏆</span>
                <span className="text-text-secondary">1st Prize – Inter-College Website Development</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-accent-primary mt-1">🏆</span>
                <span className="text-text-secondary">2nd Prize – PU Level Web Development</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-accent-primary mt-1">🏆</span>
                <span className="text-text-secondary">Infosys Global Hackathon Participant</span>
              </li>
            </ul>
          </div>
        </div>
