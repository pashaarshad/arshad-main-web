                    ...
                    !isVisible ? (
                      <div className="flex items-center justify-center h-full bg-gradient-to-br from-bg-secondary/50 to-bg-tertiary/50 backdrop-blur-sm">
                        <div className="relative flex flex-col items-center">
                          ...
                          <p className="text-accent-secondary text-xs font-mono tracking-widest uppercase animate-pulse">Initializing System...</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-center h-full bg-gradient-to-br from-bg-secondary/50 to-bg-tertiary/50 backdrop-blur-sm">
                        <div className="relative flex flex-col items-center">
                          ...
                          <p className="text-accent-primary text-xs font-mono tracking-widest uppercase animate-pulse">Decrypting Data...</p>
                        </div>
                      </div>
                    )
                  ) : (
